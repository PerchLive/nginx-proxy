# What is this?
 - This is a customized fork of [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy/issues) release 0.6.0 

# What are the current customizations:
 - nginx upgraded to 1.19.1
